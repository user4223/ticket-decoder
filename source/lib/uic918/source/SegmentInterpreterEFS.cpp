...
Context &EFSSegment::interpret(Context &context)
{
  ...
  context.addField(prefix + "gueltigAb", std::to_string(Utility::getNumeric32(context.getPosition())));
  context.addField(prefix + "gueltigBis", std::to_string(Utility::getNumeric32(context.getPosition())));
