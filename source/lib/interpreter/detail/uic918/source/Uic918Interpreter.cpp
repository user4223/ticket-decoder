...
namespace interpreter::detail::uic
{
  ...
  common::Context Uic918Interpreter::interpret(common::Context &&context)
  {
    ...
    auto const messageTypeVersion = common::StringDecoder::consumeString(context, 2);
    ...
    auto const ricsCode = common::StringDecoder::consumeString(context, 4);
    context.addField("companyCode", ricsCode);
    auto const keyId = common::StringDecoder::consumeString(context, 5);
    ...
    auto const messageLengthString = common::StringDecoder::consumeString(context, 4);
    ...
    auto messageContext = common::Context(uncompressedMessage, std::move(context));
