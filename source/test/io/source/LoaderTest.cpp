...
namespace io::api
{
    ...
    {
        auto elements = Loader(test::support::getLoggerFactory(), Reader::create(test::support::getLoggerFactory(), api::ReaderOptions{})).load(ioEtc());
    ...
    {
        auto count = 0;
        EXPECT_EQ(5, Loader(test::support::getLoggerFactory(), Reader::create(test::support::getLoggerFactory(), api::ReaderOptions{}))
    ...
    {
        auto elements = Loader(test::support::getLoggerFactory(), Reader::create(test::support::getLoggerFactory(), api::ReaderOptions{})).loadAsync(ioEtc());
    ...
    TEST(Loader, asyncDirectoryWithHandler)
    {
        ...
        auto future = Loader(test::support::getLoggerFactory(), Reader::create(test::support::getLoggerFactory(), api::ReaderOptions{}))
    ...
    {
        auto elements = Loader(test::support::getLoggerFactory(), Reader::create(test::support::getLoggerFactory(), api::ReaderOptions{})).load(ioEtc() / "minimal.jpg");
    ...
    {
        auto count = 0;
        EXPECT_EQ(1, Loader(test::support::getLoggerFactory(), Reader::create(test::support::getLoggerFactory(), api::ReaderOptions{}))
    ...
    TEST(Loader, pdfFile)
    {
        auto elements = Loader(test::support::getLoggerFactory(), Reader::create(test::support::getLoggerFactory(), api::ReaderOptions{})).load(ioEtc() / "minimal.pdf");
        EXPECT_EQ(1, elements.size());
    ...
    {
        auto loader = Loader(test::support::getLoggerFactory(), Reader::create(test::support::getLoggerFactory(), api::ReaderOptions{}));
    ...
    {
        auto elements = Loader(test::support::getLoggerFactory(), Reader::create(test::support::getLoggerFactory(), api::ReaderOptions{})).load(ioEtc() / "two-page.pdf");
